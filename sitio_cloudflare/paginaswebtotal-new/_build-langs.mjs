...
DICT.ru = {
  ...
  eng2_d:"200M+ пользователей в неделю. Ваш бренд должен быть цитируемым ответом.",
  eng3_d:"Оптимизируем, чтобы Gemini цитировал ваш сайт как авторитетный источник.",
  eng4_d:"100M+ запросов в месяц. Позиционируем ваш контент для появления там.",
...
DICT.zh = {
  __meta:{ title:"Páginas Web Total | 数字营销与高级SEO机构", desc:"专注于网站排名、技术SEO、GEO以及在生成式搜索引擎中可见度的机构：Google AI Overviews、ChatGPT、Perplexity、Gemini。", ogTitle:"Páginas Web Total | SEO与GEO机构", ogDesc:"我们助您的业务在Google、Bing、ChatGPT、Gemini、Perplexity和AI Overviews中获得排名。" },
  ...
  services_sub:"每项策略都旨在带来真实可见度、高质量自然流量以及在生成式引擎中的引用。",
  ...
  svc6_t:"分析与报告", svc6_d:"使用GA4和Power BI的实时仪表板。衡量传统与生成式可见度。",
  ...
  geo_sub:"2026年，40%的搜索由AI无点击解决。被引用就是新的第一名。",
  ...
  step1_t:"诊断与基准分析", step1_d:"技术审计、可见度分析以及传统SEO和GEO的竞争对手基准分析。",
  step2_t:"关键词与内容策略", step2_d:"语义研究、意图分类和生成式可见度分析。",
...
DICT.hi = {
  ...
  hero_title:`हावी रहें<br><span class="line-neon">खोज परिणामों पर।</span>`,
  ...
  hero_btn1:"मैं रैंक करना चाहता हूँ", hero_btn2:"सेवाएँ देखें",
...
AI.zh = {
  ...
  services:[
    ...
    ["分析与报告","使用GA4和Power BI的实时仪表板。通过月度报告衡量传统与生成式可见度。"]
  ],
  faq:[
